// ── Tracker UI/event logic moved from popup.js ──
export async function initTrackerHandlers() {
  // ...moved code from popup.js...
}

export function scheduleTrackerSave(card) { /* ... */ }
export async function saveTrackerCard(card, opts) { /* ... */ }
...
export function clearTrackerDragState() { /* ... */ }
export function getTrackerDragAfterElement(container, y) { /* ... */ }
export async function persistTrackerBoardOrder(movedId, destinationStatus) { /* ... */ }
...
export function toggleTrackerAddForm(forceOpen) { /* ... */ }
export function resetTrackerDraftForm() { /* ... */ }
export function setTrackerAddStatus(msg, type) { /* ... */ }
export function setTrackerScreenStatus(msg, type) { /* ... */ }
export function syncTrackerFilterUi() { /* ... */ }
export function fillTrackerDraftForm(draft) { /* ... */ }
export function readTrackerDraftForm() { /* ... */ }
export async function importCurrentPageIntoTrackerForm() { /* ... */ }
export async function saveNewApplicationFromForm() { /* ... */ }
export function renderTrackerCard(app) { /* ... */ }
export async function deleteTrackerCard(card) { /* ... */ }
export function hasActiveTrackerFilters() { /* ... */ }
export function filterTrackerApplications(applications, query, opts) { /* ... */ }
